...
const SUPABASE_CONFIGURED =
  ...
  !CONFIG.SUPABASE_URL.includes('tosymztbubcntseituqp.supabase.co') &&
  !CONFIG.SUPABASE_ANON_KEY.includes('sb_publishable_mtYAs1v8hSGYganmJrcEqg_pHm79qzw');

let supabaseClient = null;
if (SUPABASE_CONFIGURED && window.supabase) {
  supabaseClient = window.supabase.createClient(CONFIG.tosymztbubcntseituqp.supabase.co, CONFIG.sb_publishable_mtYAs1v8hSGYganmJrcEqg_pHm79qzw);
}
